...
Security fixes target the latest version published on the [Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=grikomsn.grok-copilot-chat). Update to the latest release before reporting an issue that may already be fixed.
...
- Relevant logs with tokens, prompts, and personal data removed
